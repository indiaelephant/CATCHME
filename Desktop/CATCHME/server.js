...
app.get('/memberinfo/update',requireLogin, (req, res) => {
    res.sendFile(__dirname + '/views/memberUpdate.html');
});

app.get('/reissuepass', (req, res) => {
    res.sendFile(__dirname + '/views/reissuePass.html');
});

app.get('/memberinfo/updatepassword',requireLogin, (req, res) => {
    res.sendFile(__dirname + '/views/updatePassword.html');
});

app.get('/memberdelete',requireLogin, (req, res) => {
